...
# untuk membagi data menjadi data pelatihan dan pengujian.
from sklearn.neighbors import KNeighborsClassifier # Mengimpor algoritma K-Nearest Neighbors
# (KNN) dari scikit-learn untuk model klasifikasi.
# Load data # Memuat dataset diabetes dari file CSV yang berisi informasi pasien dan hasil
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2) # Menggunakan fungsi
# train_test_split dari scikit-learn untuk membagi data.
# Train model # Memulai proses pelatihan model dengan menggunakan data pelatihan (X_train,
# y_train).
...
# Save model # Menyimpan model yang telah dilatih untuk keperluan penggunaan kembali di
# kemudian hari.
...
# Save test data # Menyimpan data hasil pengujian (X_test dan y_test) untuk referensi atau analisis
# lebih lanjut.
